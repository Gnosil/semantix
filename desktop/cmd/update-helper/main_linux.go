...
// Command semantix-update-helper (Linux) installs a verified .deb under Polkit.
...
const (
	...
	phasePrefix = "SEMANTIX_UPDATE_PHASE="
)
...
func realDeps() installDeps {
	return installDeps{
		geteuid:          os.Geteuid,
		getenv:           os.Getenv,
		mkTempDir:        func() (string, error) { return os.MkdirTemp("", "semantix-update-*") },
