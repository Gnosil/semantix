...
// importThemePackZIP validates and extracts a .semantix-theme ZIP into a staging dir.
...
func extractThemeZip(zr *zip.Reader) (*ThemePackManifest, string, error) {
	...
	staging, err := os.MkdirTemp("", "semantix-theme-import-*")
	if err != nil {
		return nil, "", err
	}
	cleanup := true
...
// scanThemeZipEntries validates the container shape every .semantix-theme ZIP
