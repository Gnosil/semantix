...
func TestCreateDeliveryWorktreeRegistersAndOpensManagedProject(t *testing.T) {
	...
	t.Setenv("SEMANTIX_STATE_HOME", home)
	...
	if result.WorkspaceRoot != isolatedRoot || result.Branch != "semantix/delivery-test" || !result.SourceDirty {
