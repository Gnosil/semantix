...
const FONT_FAMILY_KEY = "semantix-font-family";
const CUSTOM_FONT_KEY = "semantix-font-family-custom";
const MONO_FONT_FAMILY_KEY = "semantix-mono-font-family";
const CUSTOM_MONO_FONT_KEY = "semantix-mono-font-family-custom";
