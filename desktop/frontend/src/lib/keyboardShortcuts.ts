...
const SHORTCUTS_STORAGE_KEY = "semantix.customShortcuts";
const SHORTCUTS_CHANGED_EVENT = "semantix:shortcuts-changed";
...
export const SHORTCUT_DEFINITIONS: readonly ShortcutDefinition[] = [
  ...
  // so native textarea history and Semantix transactions share one chord.
  {
