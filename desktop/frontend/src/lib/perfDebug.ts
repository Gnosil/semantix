// perfDebug — the window.__semantixPerf introspection hook used by the
...
export interface SemantixPerfHook {
...
declare global {
  interface Window {
    __semantixPerf?: SemantixPerfHook;
  }
}
